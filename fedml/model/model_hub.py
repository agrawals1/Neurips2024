...
from fedml.model.cv.cnn import CNN_DropOut, CNN_WEB, MnistNet
...
def create(args, output_dim):
    ...
    if model_name == "CNN_Mnist" and (args.dataset == "MNIST" or args.dataset == "FMNIST"):
        ...
        model = resnet18(num_classes = 10, group_norm=args.group_norm_size, pretrained = True)
    elif model_name == "RESNET_18" and args.dataset == "CIFAR100":
        logging.info("RESNET_18 + CIFAR100")
        model = resnet18(num_classes = 100, group_norm=args.group_norm_size, pretrained = True)
